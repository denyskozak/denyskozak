...
export default function Hero() {
  const skills = ['Frontend Lead', 'Full-stack Developer', 'Software Architect'];
  const greetings = ["Hello", "Ola", "Привет", "Привіт"];
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 w-full h-full">
        <Spline
          scene="https://prod.spline.design/Cwdq1By79RGXPCXP/scene.splinecode"
          aria-label="Interactive 3D animation"
          onSplineScroll={e => e.preventDefault()}
        />
      </div>
      ...
      <div className="relative z-20 flex items-center justify-center w-full h-full p-8 text-center bg-black/20 pointer-events-none sm:p-16 md:p-24">
        <div className="max-w-md pointer-events-auto">
          <h1 className="font-pixel flex items-center justify-center gap-x-2 text-5xl font-bold text-white md:text-7xl lg:text-7xl [text-shadow:_0_3px_5px_rgb(0_0_0_/_40%)]">
