...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/denys-kozak-0175b0109', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/denyskozak', icon: ICONS.GitHub },
  // { name: 'X', url: 'https://x.com/Ashif_Elahi01', icon: ICONS.Twitter },
  { name: 'Mail', url: 'mailto:denys.kozak.self@gmail.com', icon: ICONS.Mail },
];
